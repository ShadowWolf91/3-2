...
/* Variable declaration */_LOCAL REAL z,x;/* init part of task */
void _INIT fixw ( void ){  /* set variable */  x=3;}/* cyclic part of task */
void _CYCLIC tanex( void ){  /* call function */  z = tanh( x );}